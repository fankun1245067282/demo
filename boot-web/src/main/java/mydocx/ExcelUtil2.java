...
public class ExcelUtil2 {
    ...
    private static Map<String, String> generateDataByRow(Row row) {
        ...
        try {
            ...
            String ABCDEF1Str1 =  improstr(df.format(DataUtils.round(ABCDEF1, 2)));
            if(!ABCDEF1Str.equals(ABCDEF1Str1)) {
            	System.out.println("MYZQZR："+MYZQZR+"剩余在贷本息合计:"+ABCDEF1);
            }
            ...
            String ABCDEF2Str2 =  improstr(df.format(DataUtils.round(ABCDEF2, 2)));
            if(!ABCDEF2Str.equals(ABCDEF2Str2)) {
            	System.out.println("MYZQZR："+MYZQZR+"剩余在贷本金:"+ABCDEF2);
            }
            ...
            String ABCDEF3Str2 =  improstr(df.format(DataUtils.round(ABCDEF3, 2)));
            if(!ABCDEF3Str.equals(ABCDEF3Str2)) {
            	System.out.println("MYZQZR："+MYZQZR+"利息:"+ABCDEF3);
            }
