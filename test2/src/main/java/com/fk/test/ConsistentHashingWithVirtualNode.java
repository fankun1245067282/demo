...
/**
 * 一致性Hash算法实现版本2：带虚拟节点 在理解了使用虚拟节点来改善一致性Hash算法的理论基础之后，就可以尝试开发代码了。编程方面需要考虑的问题是：
 * 
 * 1、一个真实结点如何对应成为多个虚拟节点？
 * 
 * 2、虚拟节点找到后如何还原为真实结点？
 * 
 * 这两个问题其实有很多解决办法，我这里使用了一种简单的办法，给每个真实结点后面根据虚拟节点加上后缀再取Hash值，
...
public class ConsistentHashingWithVirtualNode {
	...
	private static String getServer(String node) {
		...
		System.out.println("virtualNode:"+virtualNode);
